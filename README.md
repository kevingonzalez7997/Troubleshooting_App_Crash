## In the last version of the program we were able to improve our program by automizing the deployment of applications when a change is committed to github. But with great power comes great responsibility. In this case, a new hire was able to make a change without notifying anyone, resulting in a system crash. 
